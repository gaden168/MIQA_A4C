...
if __name__ == '__main__':
    ...
    # in_path = r'/root/workspace/echo_project/PublicData/UltraSoundImage/Dataset/'
    # out_path = r'/root/workspace/echo_project/PublicData/UltraSoundImage/data/'
    # splitfolders.ratio(in_path, out_path, seed=1337, ratio=(0.6, 0.2, 0.2))

    root = r'/root/workspace/echo_project/PublicData/UltraSoundImage/data/'
    ...
    for epoch in range(epochs):
        ...
        if epoch > 20 and epoch % 20 == 0:
            print(classification_report(label_all, prob_all, labels=[0, 1, 2]))
        # 进行动态学习率的调整
        scheduler.step()
